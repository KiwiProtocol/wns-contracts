...
interface IWormhole {
    ...
    function parseAndVerifyVM(bytes memory encodedVM) external view returns (
...
contract WNSCrossChainSync is Initializable, OwnableUpgradeable, PausableUpgradeable {
    ...
    function receiveMessage(bytes memory encodedVM) external whenNotPaused {
        ...
        // This is where you'd implement the logic to update the local registry based on the received message
